      ...
      <View style={[styles.section, { backgroundColor: colors.card, borderColor: colors.border }]}>
        ...
        <View style={styles.infoRow}>
          <View style={styles.infoLabel}>
            ...
            <Text style={[styles.infoLabelText, { color: colors.foreground }]}>Version</Text>
          </View>
        ...
        <View style={[styles.infoRow, { borderBottomWidth: 0 }]}>
          <View style={styles.infoLabel}>
            ...
            <Text style={[styles.infoLabelText, { color: colors.foreground }]}>Kitchen</Text>
          </View>
      ...
      <View style={[styles.section, { backgroundColor: colors.card, borderColor: colors.border }]}>
        ...
        <View style={[styles.infoRow, { borderBottomWidth: 0 }]}>
          <View style={styles.infoLabel}>
            ...
            <Text style={[styles.infoLabelText, { color: colors.foreground }]}>Theme</Text>
          </View>
