  ...
  const renderItem = ({ item }: { item: NonNullable<typeof menuItems.data>[number] }) => (
    ...
    >
      <View style={styles.menuCardLeft}>
        ...
        <Text style={[styles.menuCategory, { color: colors.mutedForeground }]}>Category #{item.categoryId}</Text>
    ...
    <View style={[styles.root, { backgroundColor: colors.background }]}>
      ...
      {menuItems.isLoading ? (
        ...
        <View style={styles.center}>
          ...
          <Text style={[styles.emptyText, { color: colors.mutedForeground }]}>No menu items found</Text>
        </View>
      ) : (
        <FlatList
          data={menuItems.data}
